...
def create_lambda_package():
    ...
    with zipfile.ZipFile(app_deployment_zip, 'w', zipfile.ZIP_DEFLATED) as zipf:
        # Add files from lambda directory
        ...
        # Add encyclopedia handler
        encyclopedia_handler = current_dir / "lambda" / "encyclopedia_handler.py"
        if encyclopedia_handler.exists():
            zipf.write(encyclopedia_handler, "encyclopedia_handler.py")
